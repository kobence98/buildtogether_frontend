...
class _FilteredPostsWidgetState extends State<FilteredPostsWidget> {
  ...
  void initState() {
    ...
    dataLoading = true;
    widget.session.postJson(
        '/api/posts/filtered', {'pattern': widget.pattern}).then((response) {
            ...
            return innerLoading
                ...
                : AlertDialog(
                    ...
                    actions: <Widget>[
                      ...
                      TextButton(
                        onPressed: () {
                          _onSendCouponEmailTap(
                              post.postId, context, setInnerState);
                        },
                        child: Text(
                          languages.sendLabel,
                          style: TextStyle(color: Colors.black),
